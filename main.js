...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOpeningHours)\n/* harmony export */ });\nfunction initOpeningHours() {\n  var opening = document.querySelector(\"[data-semana]\");\n  var week = opening.dataset.semana.split(\",\").map(Number);\n  var hourWeek = opening.dataset.horario.split(\",\").map(Number);\n  var now = new Date();\n  var dayNow = now.getDay();\n  var hourNow = now.getHours();\n  var isOpenDay = week.indexOf(dayNow) !== -1;\n  var isOpenHour = hourNow >= hourWeek[0] && hourNow < hourWeek[1];\n  if (isOpenDay && isOpenHour) {\n    opening.classList.add(\"aberto\");\n  }\n}\n\n//# sourceURL=webpack://animais-eslint/./src/js/opening-hours.js?");
